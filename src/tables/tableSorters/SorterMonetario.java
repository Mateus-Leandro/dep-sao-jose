...
public class SorterMonetario implements Comparator<String>{
	...
	public int compare(String valor1, String valor2) {
		...
		Double formatado1 = Double.parseDouble(valor1.substring(3, valor1.length()).replaceAll(",", "."));
		Double formatado2 = Double.parseDouble(valor2.substring(3, valor2.length()).replaceAll(",","."));
